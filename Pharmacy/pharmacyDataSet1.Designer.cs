...
namespace Pharmacy {
    ...
    public partial class pharmacyDataSet1 : global::System.Data.DataSet {
        ...
        public partial class CustomerDataTable : global::System.Data.TypedTableBase<CustomerRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public CustomerRow AddCustomerRow(string Name, string addres, string Notes, string phone, string Company, string email, bool isActive, string Image) {
...
namespace Pharmacy.pharmacyDataSet1TableAdapters {
    ...
    public partial class CustomerTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Customer] ([Name], [addres], [Notes], [phone], [Company], [email], [isActive], [Image]) VALUES (@Name, @addres, @Notes, @phone, @Company, @email, @isActive, @Image);
SELECT Id, Name, addres, Notes, phone, Company, email, isActive, Image FROM Customer WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Customer] SET [Name] = @Name, [addres] = @addres, [Notes] = @Notes, [phone] = @phone, [Company] = @Company, [email] = @email, [isActive] = @isActive, [Image] = @Image WHERE (([Id] = @Original_Id) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_phone = 1 AND [phone] IS NULL) OR ([phone] = @Original_phone)) AND ((@IsNull_Company = 1 AND [Company] IS NULL) OR ([Company] = @Original_Company)) AND ((@IsNull_email = 1 AND [email] IS NULL) OR ([email] = @Original_email)) AND ((@IsNull_isActive = 1 AND [isActive] IS NULL) OR ([isActive] = @Original_isActive)));
SELECT Id, Name, addres, Notes, phone, Company, email, isActive, Image FROM Customer WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Name, addres, Notes, phone, Company, email, isActive, Image FROM dbo.C" +
                "ustomer";
        ...
        public virtual int Insert(string Name, string addres, string Notes, string phone, string Company, string email, global::System.Nullable<bool> isActive, string Image) {
            if ((Name == null)) {
        ...
        public virtual int Update(string Name, string addres, string Notes, string phone, string Company, string email, global::System.Nullable<bool> isActive, string Image, int Original_Id, string Original_Name, string Original_phone, string Original_Company, string Original_email, global::System.Nullable<bool> Original_isActive) {
            return this.Update(Name, addres, Notes, phone, Company, email, isActive, Image, Original_Id, Original_Name, Original_phone, Original_Company, Original_email, Original_isActive, Original_Id);
        }
    }
