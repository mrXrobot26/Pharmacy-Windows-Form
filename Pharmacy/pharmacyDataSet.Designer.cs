...
namespace Pharmacy {
    ...
    public partial class pharmacyDataSet : global::System.Data.DataSet {
        ...
        public partial class ProductDataTable : global::System.Data.TypedTableBase<ProductRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public ProductRow AddProductRow(string Name, string Code, string Notes, int quantity, decimal price) {
...
namespace Pharmacy.pharmacyDataSetTableAdapters {
    ...
    public partial class ProductTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Product] WHERE (([Id] = @Original_Id) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_Code = 1 AND [Code] IS NULL) OR ([Code] = @Original_Code)) AND ((@IsNull_quantity = 1 AND [quantity] IS NULL) OR ([quantity] = @Original_quantity)) AND ((@IsNull_price = 1 AND [price] IS NULL) OR ([price] = @Original_price)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Product] ([Name], [Code], [Notes], [quantity], [price]) VALUES" +
                " (@Name, @Code, @Notes, @quantity, @price);\r\nSELECT Id, Name, Code, Notes, quant" +
                "ity, price FROM Product WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Product] SET [Name] = @Name, [Code] = @Code, [Notes] = @Notes, [quantity] = @quantity, [price] = @price WHERE (([Id] = @Original_Id) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_Code = 1 AND [Code] IS NULL) OR ([Code] = @Original_Code)) AND ((@IsNull_quantity = 1 AND [quantity] IS NULL) OR ([quantity] = @Original_quantity)) AND ((@IsNull_price = 1 AND [price] IS NULL) OR ([price] = @Original_price)));
SELECT Id, Name, Code, Notes, quantity, price FROM Product WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Name, Code, Notes, quantity, price FROM dbo.Product";
        ...
        public virtual int Delete(int Original_Id, string Original_Name, string Original_Code, global::System.Nullable<int> Original_quantity, global::System.Nullable<decimal> Original_price) {
        ...
        public virtual int Insert(string Name, string Code, string Notes, global::System.Nullable<int> quantity, global::System.Nullable<decimal> price) {
            if ((Name == null)) {
        ...
        public virtual int Update(string Name, string Code, string Notes, global::System.Nullable<int> quantity, global::System.Nullable<decimal> price, int Original_Id, string Original_Name, string Original_Code, global::System.Nullable<int> Original_quantity, global::System.Nullable<decimal> Original_price, int Id) {
            if ((Name == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Code, string Notes, global::System.Nullable<int> quantity, global::System.Nullable<decimal> price, int Original_Id, string Original_Name, string Original_Code, global::System.Nullable<int> Original_quantity, global::System.Nullable<decimal> Original_price) {
            return this.Update(Name, Code, Notes, quantity, price, Original_Id, Original_Name, Original_Code, Original_quantity, Original_price, Original_Id);
        }
    }
